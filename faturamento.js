...
const somaFaturamento = faturamentoDiario.reduce((total, dia) => total + dia.valor, 0);
const mediaFaturamento = somaFaturamento / faturamentoDiario.length;

// número de dias com faturamento diário acima da média mensal
const diasAcimaDaMedia = faturamentoDiario.filter(dia => dia.valor > mediaFaturamento).length;
